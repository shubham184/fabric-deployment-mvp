...
provider "fabric" {
  ...
  # For production, always use service principal authentication
  # Never use user authentication in production environments
}
...
# Output deployment summary for production monitoring
output "deployment_summary" {
  description = "Summary of deployed resources for production monitoring"
